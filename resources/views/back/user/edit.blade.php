...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h4 class="fw-bold mg-4">Edit User Profile</h4>
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="avatar-edit" type="file" class="form-control" name="avatar">
                                    @if($user->avatar)
                                        <img src="/avatars/{{ $user->avatar }}" class="img-fluid" id="preview-avatar">
                                    @else
                                        <img src="/avatars/user.png" class="img-fluid" id="preview-avatar">
                                    @endif
                                </div>
                            </div>
